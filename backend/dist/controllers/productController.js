...
exports.searchProducts = exports.updateStock = exports.getProductsByCategory = exports.getFeaturedProducts = exports.deleteProduct = exports.updateProduct = exports.createProduct = exports.getProductById = exports.getAllProducts = void 0;
const prisma_1 = require("../config/prisma");
const getAllProducts = async (req, res, next) => {
    try {
        const { category, subCategory, minPrice, maxPrice, minWeight, maxWeight, featured, inStock, search, page = 1, limit = 12, sortBy = 'createdAt', sortOrder = 'desc' } = req.query;
        const where = {};
        if (category)
...
const createProduct = async (req, res, next) => {
    try {
        const { name, category, subCategory, description, price, originalPrice, images, weight, stockQuantity, featured, tags, nutritionalInfo, storageInstructions, shelfLife, origin, isHalal, isOrganic, discount } = req.body;
        ...
        if (images && Array.isArray(images) && images.length > 0) {
            ...
            const productWithImages = await prisma_1.prisma.product.findUnique({
                where: { id: product.id },
                include: {
                    reviews: true,
                    productImages: {
...
const searchProducts = async (req, res, next) => {
    try {
        ...
        const total = await prisma_1.prisma.product.count({ where: query });
        res.json({
            products,
            pagination: {
                page: Number(page),
