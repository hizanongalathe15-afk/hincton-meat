...
exports.apiCors = exports.productionCors = exports.developmentCors = exports.cors = void 0;
...
exports.cors = cors;
const setCorsHeaders = (req, res, config) => {
...
exports.developmentCors = (0, exports.cors)({
    origin: true,
    credentials: true
});
exports.productionCors = (0, exports.cors)({
...
exports.apiCors = (0, exports.cors)({
    origin: process.env.ALLOWED_ORIGINS?.split(',') || [
        'https://hinctonmeat.com',
        'https://www.hinctonmeat.com',
