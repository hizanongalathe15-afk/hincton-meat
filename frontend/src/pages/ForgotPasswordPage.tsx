...
const ForgotPasswordPage: React.FC<{ onNavigate?: (page: 0 | 1 | 2 | 3) => void }> = ({ onNavigate }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(t('forgot.resetInstructionsSent'))
      if (onNavigate) {
        onNavigate(3) // reset
      }
    } finally {
              ...
              <div className="grid lg:grid-cols-2">
                ...
                <div className="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-4 mt-8">
                      <h3 className="text-4xl font-bold text-white leading-tight">
                        {t('forgot.securePasswordRecovery')}
                        <br />
                        {t('forgot.recovery')}
                      </h3>
                      <p className="text-gray-400 text-lg">
                        {t('forgot.recoveryDescription')}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="relative z-10 space-y-4">
                    {[
                      { icon: Shield, text: t('forgot.secureResetProcess') },
                      { icon: Truck, text: t('forgot.fastEmailDelivery') },
                      { icon: Star, text: t('forgot.accountProtection') },
                    ].map((item, index) => (
                ...
                <div className="p-8 lg:p-12">
                  {/* Back Button */}
                  <button
                    onClick={() => onNavigate ? onNavigate(0) : window.history.back()}
                  ...
                  {/* Welcome Text */}
                  <div className="mb-8">
                    <h1 className="text-3xl font-bold text-white mb-2">{t('forgot.resetPassword')}</h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    >
                      ...
                      <span className="relative z-10">
                        {isLoading ? t('forgot.sendingResetLink') : t('forgot.sendResetLink')}
                      </span>
                    </button>
                  </form>
                  ...
                  <p className="text-center mt-6 text-gray-400 text-sm">
                    ...
                    <button
                      onClick={() => onNavigate ? onNavigate(0) : window.location.href = '/login'}
