...
export const HINCTON_PRODUCTS = [
  {
    name: 'Goat meat',
    category: 'goat',
    description: 'Whole goat, assorted cuts, processed products.',
    image: '/hincton/goat-meat.jpg',
  },
  {
    name: 'Lamb/mutton',
    category: 'lamb',
    description: 'Selected cuts and products.',
    image: '/hincton/lamb-mutton.jpg',
  },
  {
    name: 'Beef',
    category: 'beef',
    description: 'Fresh cuts, premium steaks, minced beef.',
    image: '/hincton/beef-cuts.jpg',
  },
  {
    name: 'Chicken',
    category: 'chicken',
    description: 'Whole chicken, assorted cuts, processed products.',
    image: '/hincton/chicken.jpg',
  },
  {
    name: 'Fish',
    category: 'fish',
    description: 'Fried whole fish.',
    image: '/hincton/fish.jpg',
  },
  {
    name: 'Pet food',
    category: 'pet-food',
...
export const HINCTON_QUALITY_POINTS = [
